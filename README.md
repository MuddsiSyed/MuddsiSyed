...
**My mission**: To demonstrate practical cybersecurity skills through hands-on projects, contribute to the security community, and continuously evolve with the threat landscape.
...
<div>
    ...
    <img src="https://img.shields.io/badge/-TheHive-F7931E?&style=for-the-badge&logo=TheHive&logoColor=white" />
</div>
...
**Key Features:**
- High-availability Splunk deployment with clustering
- Automated log ingestion from multiple sources
- Custom dashboards for real-time threat visualization
- Integration with AWS CloudTrail and VPC Flow Logs
- Performance optimization for large-scale data processing

**Technologies:** `Splunk Enterprise` `AWS EC2` `S3` `CloudFormation` `Linux`
...
**Key Features:**
- Multi-domain AD forest deployment
- GPO implementation for security hardening
- Integration with Splunk for AD monitoring
- Simulated attack scenarios and detection
- PowerShell-based automation scripts

**Technologies:** `Windows Server` `Active Directory` `PowerShell` `Splunk` `Sysmon`
...
I'm always excited to collaborate on cybersecurity projects, share knowledge, and contribute to the security community. Whether you're looking to:
...
*Committed to making the digital world safer, one project at a time.*
